      ...
      <div className="max-width-container mx-auto relative z-10">
        ...
        {loading ? (
          ...
          <motion.div
            ...
            className="max-w-xl mx-auto bg-red-50 border border-red-100 rounded-2xl p-8 text-center"
          >
            <AlertCircle className="w-12 h-12 text-red-400 mx-auto mb-4" />
            <h3 className="text-red-800 font-semibold text-lg mb-2">Attention Required</h3>
            <p className="text-red-600 mb-6">{error}</p>
            <div className="bg-white rounded-lg p-4 shadow-sm border border-red-100 text-left">
              <p className="text-sm text-gray-700 font-mono break-all font-semibold mb-2">
                1. Go to Supabase Dashboard &gt; Project Settings &gt; Edge Functions
              </p>
              <p className="text-sm text-gray-700 font-mono break-all font-semibold">
                2. Add a new secret: <br /><br />
                <span className="bg-gray-100 px-2 py-1 rounded">GOOGLE_PLACE_ID</span>
              </p>
            </div>
          </motion.div>
        ) : (
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {reviews.map((review, i) => (
              <motion.div
                ...
                viewport={{ once: true }}
                className="bg-white rounded-3xl p-8 border border-gray-100/80 shadow-[0_8px_30px_rgb(0,0,0,0.04)] hover:shadow-[0_20px_40px_rgb(220,38,38,0.08)] hover:-translate-y-1 transition-all duration-300 relative group"
              >
                ...
                <p className="text-gray-700 leading-relaxed mb-8 relative z-10 line-clamp-4">
                  "{review.text}"
                </p>
                ...
                <div className="flex items-center gap-4 mt-auto">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-500">{review.publishTime}</p>
                  </div>
                </div>
              </motion.div>
            ))}
