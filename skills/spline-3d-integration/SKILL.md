...
| Task                              | Guide                                            |
| --------------------------------- | ------------------------------------------------ |
| Vanilla HTML/JS embed             | [VANILLA_INTEGRATION.md](VANILLA_INTEGRATION.md) |
| React / Next.js / Vue embed       | [REACT_INTEGRATION.md](REACT_INTEGRATION.md)     |
| Performance & mobile optimization | [PERFORMANCE.md](PERFORMANCE.md)                 |
| Debugging & common problems       | [COMMON_PROBLEMS.md](COMMON_PROBLEMS.md)         |
